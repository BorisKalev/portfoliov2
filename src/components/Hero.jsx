    ...
    <>
      <LampContainer className="text-3xl">
        <div className="max-w-2xl text-center font-poppins ">
          <p className="relative sm-max:-top-8 sm-max:text-2xl bg-gradient-to-br from-slate-100 to-slate-500 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent">
            {t("intro")}
          </p>
